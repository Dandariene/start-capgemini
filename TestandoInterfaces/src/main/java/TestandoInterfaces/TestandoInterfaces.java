 ...
 * @author 55119
 */
public class TestandoInterfaces extends javax.swing.JFrame {

    /**
     * Creates new form TestandoInterfaces
     */
    public TestandoInterfaces() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestandoInterfaces.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TestandoInterfaces().setVisible(true);
            }
        });
    }
